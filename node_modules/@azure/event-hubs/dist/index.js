...
// Copyright (c) Microsoft Corporation.
const _createSpan = coreTracing.createSpanFunction({
 ...
 * @internal
 */
function createMessageSpan(operationOptions, eventHubConfig) {
    ...
    getEventHubProperties(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                clientSpan.setStatus({ code: coreTracing.SpanStatusCode.OK });
                return runtimeInfo;
            }
            catch (error) {
    ...
    _makeManagementRequest(request, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sendOperationPromise = () => tslib.__awaiter(this, void 0, void 0, function* () {
                    let count = 0;
                    ...
                    if (!this._isMgmtRequestResponseLinkOpen()) {
                        ...
                        try {
                            yield waitForTimeoutOrAbortOrResolve({
                                actionFn: () => {
                                    return coreAmqp.defaultLock.acquire(this.managementLock, () => {
                                        return this._init();
                                    });
                                },
...
(function (ConnectionContext) {
    ...
    function create(config, tokenCredential, options) {
                    ...
                    try {
                        if (this.connection.isOpen()) {
                            ...
                            for (const senderName of Object.keys(this.senders)) {
                                yield this.senders[senderName].close();
                            }
                            // Close all the receivers.
                            for (const receiverName of Object.keys(this.receivers)) {
                                yield this.receivers[receiverName].close();
                            }
                            // Close the cbs session;
                            yield this.cbsSession.close();
                            // Close the management session
                            yield this.managementSession.close();
        ...
        const onDisconnected = (context) => tslib.__awaiter(this, void 0, void 0, function* () {
            if (waitForConnectionRefreshPromise) {
                return;
            }
        ...
        function refreshConnection(context) {
            return tslib.__awaiter(this, void 0, void 0, function* () {
                const originalConnectionId = context.connectionId;
                try {
                    yield cleanConnectionContext(context);
                }
                catch (err) {
...
class InMemoryCheckpointStore {
     ...
     */
    listOwnership(_fullyQualifiedNamespace, _eventHubName, _consumerGroup) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            const ownerships = [];
...
class EventHubReceiver extends LinkEntity {
    ...
    _onAmqpMessage(context) {
        ...
        const data = fromRheaMessage(context.message);
        ...
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            while (this._isReceiving) {
                try {
                    ...
                    const receivedEvents = yield receiver.receiveBatch(this._processorOptions.maxBatchSize, this._processorOptions.maxWaitTimeInSeconds, this._abortController.signal);
                    ...
                    const span = createProcessingSpan(receivedEvents, this._context.config, this._processorOptions);
 ...
 * @internal
 */
function createProcessingSpan(receivedEvents, eventHubProperties, options) {
    const links = [];
...
class PumpManagerImpl {
     ...
     * @hidden
     */
    createPump(startPosition, connectionContext, partitionProcessor, abortSignal) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
...
class EventProcessor {
    ...
    _startPump(partitionId, abortSignal) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this._pumpManager.createPump(eventPosition, this._context, partitionProcessor, abortSignal);
            logger.verbose(`[${this._id}] PartitionPump created successfully.`);
        });
    }
    _getStartingPosition(partitionIdToClaim) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            const availableCheckpoints = yield this._checkpointStore.listCheckpoints(this._fullyQualifiedNamespace, this._eventHubName, this._consumerGroup);
     ...
     */
    _runLoopWithLoadBalancing(loadBalancingStrategy, abortSignal) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            while (!abortSignal.aborted) {
                ...
                try {
                    const { partitionIds } = yield this._context.managementSession.getEventHubProperties({
                        abortSignal: abortSignal
                    });
                    yield this._performLoadBalancing(loadBalancingStrategy, partitionIds, abortSignal);
                }
                catch (err) {
                    logger.warning(`[${this._id}] An error occured within the EventProcessor loop: ${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                    logErrorStackTrace(err);
                    // Protect against the scenario where the user awaits on subscription.close() from inside processError.
                    yield Promise.race([this._handleSubscriptionError(err), cancelLoopPromise]);
                }
                finally {
                    ...
                    yield delayWithoutThrow(delayDurationInMs, abortSignal);
                }
            }
    ...
    _performLoadBalancing(loadBalancingStrategy, partitionIds, abortSignal) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            if (abortSignal.aborted)
                throw new abortController.AbortError("The operation was aborted.");
            // Retrieve current partition ownership details from the datastore.
            const partitionOwnership = yield this._checkpointStore.listOwnership(this._fullyQualifiedNamespace, this._eventHubName, this._consumerGroup);
            if (abortSignal.aborted)
                throw new abortController.AbortError("The operation was aborted.");
            ...
            for (const partitionToClaim of uniquePartitionsToClaim) {
                ...
                yield this._claimOwnership(partitionOwnershipRequest, abortSignal);
            }
        });
    }
    /**
    ...
    abandonPartitionOwnerships() {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const allOwnerships = yield this._checkpointStore.listOwnership(this._fullyQualifiedNamespace, this._eventHubName, this._consumerGroup);
...
class EventHubConsumerClient {
    ...
    close() {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(activeSubscriptions.map((subscription) => {
...
class EventHubSender extends LinkEntity {
    ...
    constructor(context, partitionId) {
        ...
        this._onAmqpClose = (eventContext) => tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        this._onSessionClose = (eventContext) => tslib.__awaiter(this, void 0, void 0, function* () {
            const sender = this._sender || eventContext.sender;
    ...
    getMaxMessageSize(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            yield this._createLinkIfNotOpen(options);
     ...
     * @returns Promise<void>
     */
    _trySendBatch(rheaMessage, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const sendEventPromise = () => tslib.__awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                ...
                if (!this._sender.sendable() && timeoutInMs - timeTakenByInit > waitTimeForSendable) {
                    ...
                    yield coreAmqp.delay(waitTimeForSendable);
                    logger.verbose("%s Sender '%s' after waiting for a second, credit: %d available: %d", this._context.connectionId, this.name, this._sender.credit, (_b = (_a = this._sender.session) === null || _a === void 0 ? void 0 : _a.outgoing) === null || _b === void 0 ? void 0 : _b.available());
                }
                else {
                ...
                try {
                    const delivery = yield this._sender.send(rheaMessage, undefined, 0x80013700, {
                        abortSignal
                    });
    ...
    _createLinkIfNotOpen(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const createLinkPromise = () => tslib.__awaiter(this, void 0, void 0, function* () {
                return waitForTimeoutOrAbortOrResolve({
                    actionFn: () => {
                        return coreAmqp.defaultLock.acquire(this.senderLock, () => {
