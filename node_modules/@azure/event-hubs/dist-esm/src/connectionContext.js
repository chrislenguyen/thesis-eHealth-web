...
import { ConnectionContextBase, Constants, ConnectionConfig, createSasTokenProvider } from "@azure/core-amqp";
...
(function (ConnectionContext) {
    ...
    function create(config, tokenCredential, options) {
        ...
        const onDisconnected = (context) => __awaiter(this, void 0, void 0, function* () {
            if (waitForConnectionRefreshPromise) {
                return;
            }
