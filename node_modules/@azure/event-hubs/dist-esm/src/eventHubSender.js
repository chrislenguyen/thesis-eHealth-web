...
import { delay, ErrorNameConditionMapper, RetryOperationType, defaultLock, retry, translate } from "@azure/core-amqp";
...
export class EventHubSender extends LinkEntity {
    ...
    constructor(context, partitionId) {
        ...
        this._onAmqpClose = (eventContext) => __awaiter(this, void 0, void 0, function* () {
        ...
        this._onSessionClose = (eventContext) => __awaiter(this, void 0, void 0, function* () {
            const sender = this._sender || eventContext.sender;
    ...
    _trySendBatch(rheaMessage, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sendEventPromise = () => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                ...
                if (!this._sender.sendable() && timeoutInMs - timeTakenByInit > waitTimeForSendable) {
                    ...
                    yield delay(waitTimeForSendable);
    ...
    _createLinkIfNotOpen(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createLinkPromise = () => __awaiter(this, void 0, void 0, function* () {
