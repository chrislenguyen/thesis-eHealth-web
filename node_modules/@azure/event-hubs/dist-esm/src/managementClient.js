...
import { Constants, RequestResponseLink, RetryOperationType, defaultLock, isSasTokenProvider, retry, translate } from "@azure/core-amqp";
    ...
    _makeManagementRequest(request, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sendOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
                    let count = 0;
