...
class RequestResponseLink {
     ...
     */
    static create(connection, senderOptions, receiverOptions, createOptions = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            const { abortSignal } = createOptions;
            const session = yield connection.createSession({ abortSignal });
            const sender = yield session.createSender(Object.assign(Object.assign({}, senderOptions), { abortSignal }));
            const receiver = yield session.createReceiver(Object.assign(Object.assign({}, receiverOptions), { abortSignal }));
        ...
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!this._isCbsSenderReceiverLinkOpen()) {
                    ...
                    this._cbsSenderReceiverLink = yield RequestResponseLink.create(this.connection, srOpt, rxOpt, { abortSignal });
...
const ConnectionContextBase = {
    ...
    create(parameters) {
        ...
        const connectionContextBase = {
            ...
            refreshConnection() {
                const newConnection = new rheaPromise.Connection(connectionOptions);
